...
<article class="h-entry" itemscope itemtype="https://schema.org/BlogPosting"
    ...
    <div class="e-content" itemprop="articleBody">
      ...
      <p class="tos-legend yellow">Highlighted: rights GitHub claims over your content</p>
      <blockquote class="tos-ownership" cite="https://docs.github.com/en/site-policy/github-terms/github-terms-of-service">
        <p class="src">GitHub ToS — User-Generated Content</p>
      ...
      <p class="tos-legend red">Highlighted: rights you are forced to waive</p>
      <blockquote class="tos-waiver" cite="https://docs.github.com/en/site-policy/github-terms/github-terms-of-service">
        <p class="src">GitHub ToS — Section D.8</p>
      ...
      <p class="tos-legend blue">Highlighted: data GitHub collects about you</p>
      <blockquote class="tos-privacy" cite="https://docs.github.com/en/site-policy/github-terms/github-terms-for-additional-products-and-features">
        <p class="src">GitHub Additional Products Terms — Copilot</p>
...
cd yourrepo.git</code></pre>
        ...
        <li>
          ...
          <pre><code>git remote add srht <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="395e504d795e504d174a4b17514d">[email&#160;protected]</a>:~youruser/yourrepo
git push srht --mirror</code></pre>
        </li>
        <li>
          Update your local origin:
          <pre><code>git remote set-url origin <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fa9d938eba9d938ed48988d4928e">[email&#160;protected]</a>:~youruser/yourrepo</code></pre>
        </li>
        <li>
...
public-inbox-init -V2 myproject \
  ...
  <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d7baaea7a5b8bdb2b4a3fab3b2a1b2bb97bbbea4a3a4f9a4a5f9bfa3">[email&#160;protected]</a>
