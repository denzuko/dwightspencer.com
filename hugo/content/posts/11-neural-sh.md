...
<p>It is well-built. It also assumes the editor is the unit of composition. If your workflow lives in Vim, that holds. If you are working across a shell, a mail client, a plumber script, and pipelines stitched together with POSIX glue, a plugin that cannot be invoked outside the editor is a constraint, not a tool.</p>
...
git diff | neural "summarise these changes"
...
<p>Plan 9's plumber routes messages between programmes based on content rules. neural.sh fits that model without modification:</p>
